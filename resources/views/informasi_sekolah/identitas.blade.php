        ...
        <div class="col-lg-8 mb-4">
            <div class="blog-item bg-light">
                <div class="position-relative overflow-hidden">
                    <img class="img-fluid w-100" src="../images/ba.jpg" alt="smk it baitul aziz" style="height: 400px; object-fit: cover;">
                </div>
                <div class="p-4">
                    <h3 class="mb-3">Judul Konten Blog</h3>
                    <p>Isi konten blog Anda di sini. Anda dapat menambahkan teks sebanyak yang Anda inginkan untuk menjelaskan lebih lanjut tentang topik yang Anda bahas dalam blog ini.</p>
                </div>
            </div>
        </div>
